        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>M</b>ta</span>
                </a>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-info" href="Controlador?accion=editar&id=<%= per.getId_usuario()%>">Editar</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminar&id=<%= per.getId_usuario()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2020 <a href="#">MTA</a>.</strong> Todos los derechos reservados.
            </footer>
